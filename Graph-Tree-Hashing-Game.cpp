...
#include <cmath>
#include <algorithm>
//Kelompok 7-Permainan harta karun (Graph - Tree - Hashing)
//Edwin Christopher Henry-C14220117-(Hash)
//Bryan Davila Effendi-C14220079-(Tree)
//Fernando Howe Tanoyo-C14220194-(MiniGame(tebak angka dan kata))
//Gabriel Gonardo=C14220232-(Graph)
//main dan playStickmanGame bersama
